...
[Admin("VisualLayouts/Preview/{action}", "VisualLayouts.Preview.{action}")]
public sealed class PreviewController : Controller
{
    ...
    public async Task<IActionResult> Render()
    {
        ...
        {
            HttpContext.Items["OrchardCore.PreviewVisualLayout"] = new VisualLayoutViewModel { Name = name, State = state };
        }
